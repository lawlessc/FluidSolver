  ...
  //  Camera gradCam = null;
    ...
    public void setupObjects()
    {
       ...
       //does advection
        ...
        subGradientObj.setRenderHook(jacobiRenderHook);
    ...
    //    gradientWorld = new World();
      //  gradCam=gradientWorld.getCamera();
     //   gradCam.setPosition(-10, 0, 0);
     //   gradCam.lookAt(new SimpleVector(0, 0, 0));
